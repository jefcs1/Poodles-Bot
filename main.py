...
bot = commands.Bot(
    ...
    activity=discord.Activity(
        type=discord.ActivityType.watching, name="Poodle's Streams"
    ),
)
...
handler = logging.FileHandler(filename="logs/PoodleLogs.log", encoding="utf-8", mode="w")
discord.utils.setup_logging(handler=handler)
logger = logging.getLogger("PoodleLogs")
